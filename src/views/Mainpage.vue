<template>
  <div>
    ...
    <div class="flex" v-if="readyToshowMainPage">
      ...
      <div class="box">
        <labelbox class="box2" msg="死者数" idname="dead" :lavelValue="dead" />
      </div>
      <div class="box">
        <labelbox class="box3" msg="PCR検査数" idname="pcr" :lavelValue="pcr" />
      </div>
      <div class="box">
        <labelbox
          class="box4"
      ...
      <div class="box">
        <div class="box27">
          ...
          <input
            ...
            class="tab-switch"
            checked="checked"
          /><label :for="zenkokuId" class="tab-label">岡山</label>
          <div class="text">
            {{ use }}/{{ all }}<br />
