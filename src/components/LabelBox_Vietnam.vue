<template>
  <div class="containar-lg">
    ...
    <section class="row m-1">
      <section class="containar">Tổng nhiễm</section>
    </section>
    ...
    <section class="row m-1">
      <section class="containar">Số kiểm tra PCR</section>
    </section>
    <section class="row mx-1">
      <div class="containar" v-if="kansensya.tsuyama">
    ...
    <section class="row p-1">
      <section class="containar">Tử vong</section>
    </section>
    ...
    <section class="row p-1">
      <section class="containar">Khỏi</section>
    </section>
    <section class="row px-1">
      <div class="containar" v-if="kansensya.tsuyama">
    ...
    <section class="row p-1">
      <section class="containar">Đang điều trị</section>
    </section>
    <section class="row px-1">
      <div class="containar" v-if="kansensya.okayama">
        <p class="lead">
